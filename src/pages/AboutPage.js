  ...
  <Container className="mt-4 mb-3">
    <Row className="mb-3">
      <Col>
        ...
        <p>Chedex is a full-text search webapp of Tun Mahathir's official blog posts, <a href="http://chedet.cc/">chedet.cc</a>. You're able to search chedet blog posts by using single/mutiple keyword. The results is sorted by rationality ranking/scoring <a href="https://github.com/weixsong/elasticlunr.js">(read more)</a></p>
      </Col>
    </Row>
    <Row className="mb-3">
      <Col>
